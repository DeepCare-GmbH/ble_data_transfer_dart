...
class ScreenSaver extends $pb.GeneratedMessage {
  ...
  factory ScreenSaver.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ScreenSaver.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  ScreenSaver copyWith(void Function(ScreenSaver) updates) =>
      super.copyWith((message) => updates(message as ScreenSaver))
          as ScreenSaver; // ignore: deprecated_member_use
  ...
  @$core.pragma('dart2js:noInline')
  static ScreenSaver getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ScreenSaver>(create);
  static ScreenSaver? _defaultInstance;

  @$pb.TagNumber(1)
  $core.bool get date => $_getBF(0);
  @$pb.TagNumber(1)
  set date($core.bool v) {
    $_setBool(0, v);
  }
  ...
  @$pb.TagNumber(7)
  set backgroundImage($core.String v) {
    $_setString(6, v);
  }
