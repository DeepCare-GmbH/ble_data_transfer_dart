...
class Statistics extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Statistics', createEmptyInstance: create)
    ..a<$core.double>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'standtime', $pb.PbFieldType.OF)
    ..a<$core.double>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sittime', $pb.PbFieldType.OF)
    ..a<$core.double>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ergonomic', $pb.PbFieldType.OF)
    ..a<$core.double>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'hunching', $pb.PbFieldType.OF)
    ..a<$core.double>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'layback', $pb.PbFieldType.OF)
    ..a<$core.double>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'met', $pb.PbFieldType.OF)
    ..a<$core.double>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'arm', $pb.PbFieldType.OF)
    ..a<$core.double>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'leg', $pb.PbFieldType.OF)
    ..a<$core.double>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'back', $pb.PbFieldType.OF)
    ..a<$core.double>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'head', $pb.PbFieldType.OF)
    ..a<$core.double>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'shoulder', $pb.PbFieldType.OF)
    ..a<$core.int>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'exercises', $pb.PbFieldType.OU3)
    ..a<$core.int>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'breaks', $pb.PbFieldType.OU3)
    ..a<$core.int>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'poseChanges', $pb.PbFieldType.OU3)
    ..a<$core.double>(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'standingInRow', $pb.PbFieldType.OF)
    ..a<$core.double>(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sittingInRow', $pb.PbFieldType.OF)
    ..a<$core.double>(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'water', $pb.PbFieldType.OF)
    ..e<Statistics_Mode>(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mode', $pb.PbFieldType.OE, defaultOrMaker: Statistics_Mode.UNKNOWN, valueOf: Statistics_Mode.valueOf, enumValues: Statistics_Mode.values)
    ..a<$core.double>(19, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'movement', $pb.PbFieldType.OF)
    ..aOB(20, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tableUp')
  ...
  @$pb.TagNumber(1)
  set standtime($core.double v) { $_setFloat(0, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set sittime($core.double v) { $_setFloat(1, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set ergonomic($core.double v) { $_setFloat(2, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set hunching($core.double v) { $_setFloat(3, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set layback($core.double v) { $_setFloat(4, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set met($core.double v) { $_setFloat(5, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set arm($core.double v) { $_setFloat(6, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set leg($core.double v) { $_setFloat(7, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set back($core.double v) { $_setFloat(8, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(10)
  set head($core.double v) { $_setFloat(9, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(11)
  set shoulder($core.double v) { $_setFloat(10, v); }
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(12)
  set exercises($core.int v) { $_setUnsignedInt32(11, v); }
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(13)
  set breaks($core.int v) { $_setUnsignedInt32(12, v); }
  @$pb.TagNumber(13)
  ...
  @$pb.TagNumber(14)
  set poseChanges($core.int v) { $_setUnsignedInt32(13, v); }
  @$pb.TagNumber(14)
  ...
  @$pb.TagNumber(15)
  set standingInRow($core.double v) { $_setFloat(14, v); }
  @$pb.TagNumber(15)
  ...
  @$pb.TagNumber(16)
  set sittingInRow($core.double v) { $_setFloat(15, v); }
  @$pb.TagNumber(16)
  ...
  @$pb.TagNumber(17)
  set water($core.double v) { $_setFloat(16, v); }
  @$pb.TagNumber(17)
  ...
  @$pb.TagNumber(18)
  set mode(Statistics_Mode v) { setField(18, v); }
  @$pb.TagNumber(18)
  ...
  @$pb.TagNumber(19)
  set movement($core.double v) { $_setFloat(18, v); }
  @$pb.TagNumber(19)
  ...
  @$pb.TagNumber(20)
  set tableUp($core.bool v) { $_setBool(19, v); }
  @$pb.TagNumber(20)
