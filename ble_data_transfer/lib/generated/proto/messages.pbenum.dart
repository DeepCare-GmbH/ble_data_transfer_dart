...
class Target extends $pb.ProtobufEnum {
  ...
  static const Target DOCKER_IMAGE = Target._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'DOCKER_IMAGE');
  static const Target USER_BACKGROUND_IMAGE = Target._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'USER_BACKGROUND_IMAGE');
  static const Target DATA = Target._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'DATA');
  static const Target BASH_SCRIPT = Target._(4, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'BASH_SCRIPT');
  static const Target ANSIBLE_SCRIPT = Target._(5, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'ANSIBLE_SCRIPT');
  static const Target PLAIN_FILE = Target._(6, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PLAIN_FILE');
...
class StartTransferRequest_Direction extends $pb.ProtobufEnum {
  static const StartTransferRequest_Direction PHONE_TO_DEVICE = StartTransferRequest_Direction._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PHONE_TO_DEVICE');
  static const StartTransferRequest_Direction DEVICE_TO_PHONE = StartTransferRequest_Direction._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'DEVICE_TO_PHONE');
