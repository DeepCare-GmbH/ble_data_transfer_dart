...
class TransferData extends $pb.GeneratedMessage {
  ...
  factory TransferData.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory TransferData.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  TransferData copyWith(void Function(TransferData) updates) =>
      super.copyWith((message) => updates(message as TransferData))
          as TransferData; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static TransferData create() => TransferData._();
  TransferData createEmptyInstance() => create();
  static $pb.PbList<TransferData> createRepeated() =>
      $pb.PbList<TransferData>();
  @$core.pragma('dart2js:noInline')
  static TransferData getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<TransferData>(create);
  static TransferData? _defaultInstance;

  @$pb.TagNumber(1)
  $core.int get address => $_getIZ(0);
  @$pb.TagNumber(1)
  set address($core.int v) {
    $_setSignedInt32(0, v);
  }
